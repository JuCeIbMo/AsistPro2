...
function App() {
  ...
  const whatsappRedirect = () => {
    window.open('https://wa.me/1234567890?text=Hola%20AsistPro,%20quiero%20comenzar%20mi%20prueba%20gratuita', '_blank');
  };
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="hidden md:flex items-center space-x-4">
              ...
              <button className="bg-gradient-to-r from-orange-600 to-orange-700 text-white px-6 py-2 rounded-lg hover:from-orange-700 hover:to-orange-800 transition-all font-semibold">
                Prueba Gratis
              </button>
            </div>
          ...
          {isMenuOpen && (
            <div className="md:hidden py-4 border-t">
              <nav className="flex flex-col space-y-4">
                ...
                <button className="bg-gradient-to-r from-orange-600 to-orange-700 text-white px-6 py-2 rounded-lg hover:from-orange-700 hover:to-orange-800 transition-all text-left font-semibold">
                  Prueba Gratis
                </button>
              </nav>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-gradient-to-r from-orange-600 to-orange-700 text-white px-8 py-4 rounded-xl font-semibold hover:from-orange-700 hover:to-orange-800 transition-all transform hover:scale-105 shadow-lg">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {pricingPlans.map((plan, index) => (
              <div key={index} className={`rounded-2xl p-8 ${plan.color} relative ${plan.popular ? 'ring-2 ring-orange-500' : ''}`}>
                ...
                <button className={`w-full ${plan.buttonColor} text-white py-3 px-6 rounded-xl font-semibold transition-all transform hover:scale-105 shadow-lg`}>
                  Comenzar Prueba Gratuita
                </button>
              </div>
            ))}
